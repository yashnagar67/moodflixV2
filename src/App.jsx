...
function App() {
  ...
  return (
    <Router>
          ...
          <>
            {/* Navbar can be conditional ya always visible */}
            {/* <Navbar /> */}
            ...
            <Routes>
              ...
              <Route path="/go/:id" element={<MovieDetail />} />
              <Route path="/download/:title/:quality" element={<Download />} />
              {/* <Route path="/go/:id" element={<JumpPage />} /> */}
              <Route path="/categories" element={<Watching />} />
            </Routes>
          </>
